import { Globe, Package, Shield, Tag } from "lucide-react";
    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          ...
          alt="Premium Human Hair — SS GLOBAL TRADE"
        ...
        <div className="max-w-3xl">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-gold text-xs font-black tracking-[0.3em] uppercase">
              India's Premier Hair Exporter
            </span>
          </div>

          {/* Headline */}
          <h1 className="font-heading font-black leading-tight mb-6">
            <span className="text-cream block text-5xl sm:text-6xl lg:text-7xl">
              Premium Human Hair.
            </span>
            <span className="gold-text-gradient block text-5xl sm:text-6xl lg:text-7xl">
              Global Standards.
            </span>
            <span className="text-cream block text-5xl sm:text-6xl lg:text-7xl">
              Trusted Worldwide.
          ...
          <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 border border-gold/40 bg-charcoal-800/50">
            <span className="text-gold font-black text-sm tracking-[0.25em] uppercase">
              SS GLOBAL TRADE
            </span>
          </div>
          ...
          <p className="text-cream-muted text-lg sm:text-xl leading-relaxed mb-10 max-w-2xl font-medium">
            Delivering 100% authentic human hair from India to global brands,
            salons, and wholesalers.
            <span className="text-cream font-bold">
              {" "}
              Quality you can trust. Supply you can scale.
            </span>
          </p>
