...
const differentiators = [
  {
    ...
    description:
      "Every batch is verified for authenticity. No synthetic blends, no compromises.",
  },
  {
    icon: Settings,
    title: "Strict Quality Control Process",
    description:
      "Multi-stage quality inspection from sourcing to final packaging ensures consistent excellence.",
  },
  {
    icon: Tag,
    title: "Custom Branding & Private Label",
    description:
      "Launch your own brand with our OEM and private label packaging solutions.",
  },
  {
    icon: Package,
    title: "Low MOQ Available",
    description:
      "Start small and scale up. We accommodate businesses at every stage of growth.",
  },
  {
    icon: Truck,
    title: "Fast & Secure International Shipping",
    description:
      "Reliable worldwide delivery via DHL and FedEx with full tracking and insurance.",
  },
  {
    icon: MessageSquare,
    title: "Transparent Pricing & Communication",
    description:
      "No hidden fees. Clear pricing, honest timelines, and responsive support at every step.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-heading font-black text-cream mb-4 text-4xl sm:text-5xl">
            Why Choose{" "}
            <span className="gold-text-gradient">SS GLOBAL TRADE?</span>
          </h2>
          <p className="text-cream-muted text-base max-w-xl mx-auto font-medium">
            We go beyond supply — we build partnerships built on quality, trust,
