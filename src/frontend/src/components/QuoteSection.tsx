      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-heading font-black text-cream mb-4 text-4xl sm:text-5xl">
            Ready to{" "}
            <span className="gold-text-gradient">Start Your Order?</span>
          </h2>
          <p className="text-cream-muted text-base max-w-xl mx-auto font-medium">
            Contact us today for a personalized quote tailored to your business
            needs.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-3">
            {submitted ? (
              <div className="flex flex-col items-center justify-center h-full min-h-[400px] text-center p-10 bg-charcoal-700 border border-gold/20">
                ...
                <h3 className="font-heading font-black text-cream text-2xl mb-3">
                  Quote Request Sent!
                </h3>
              ...
              <form
                ...
                className="space-y-5 bg-charcoal-700 border border-gold/10 p-8"
              >
                <div className="grid sm:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    <Label
                      htmlFor="fullName"
                      className="text-cream text-sm font-bold uppercase tracking-wide"
                    >
                      Full Name
                    </Label>
                    <Input
                ...
                <div className="space-y-2">
                  <Label className="text-cream text-sm font-bold uppercase tracking-wide">
                    Product Interest
                  </Label>
                  <Select
                    value={formData.product}
                    onValueChange={(val) =>
                      setFormData({ ...formData, product: val as Product })
                    }
                    required
                  >
                    ...
                    <SelectContent className="bg-charcoal-800 border-gold/20">
                      {productOptions.map((opt) => (
                        <SelectItem
                          key={opt.value}
                          value={opt.value}
                          className="text-cream hover:text-gold focus:text-gold font-medium"
                        >
                          {opt.label}
                        </SelectItem>
                      ))}
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="p-6 bg-charcoal-700 border border-gold/10">
              ...
              <p className="text-cream-muted text-sm mb-4 font-medium">
            ...
            {/* Contact Details */}
            <div className="p-6 bg-charcoal-700 border border-gold/10">
              <h3 className="font-heading font-bold text-cream text-lg mb-5">
                Contact Information
              </h3>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-gold text-xs font-black uppercase tracking-wide mb-0.5">
                      Email
                    </p>
                    <a
                      href={`mailto:${contactInfo?.email || "infossglobaltrade.in@gmail.com"}`}
                      className="text-cream-muted text-sm hover:text-gold transition-colors font-medium"
                    >
                      {contactInfo?.email || "infossglobaltrade.in@gmail.com"}
                    </a>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-cream-muted text-sm font-medium">
                      {contactInfo?.location ||
                        "Haldia, West Bengal, India – 721657"}
                    </span>
                  </div>
                </li>
              </ul>
              ...
              <ul className="space-y-2 text-sm font-medium">
                <li className="flex justify-between">
                  ...
                  <span className="text-cream font-bold">
                    {businessHours?.mondayToFriday || "9:00 AM – 6:00 PM IST"}
                  </span>
                </li>
                <li className="flex justify-between">
                  <span className="text-cream-muted">Saturday</span>
                  <span className="text-cream font-bold">
                    {businessHours?.saturday || "10:00 AM – 2:00 PM IST"}
                  </span>
                </li>
                <li className="flex justify-between">
