      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="mb-4">
              <h3 className="font-heading font-black text-gold text-xl tracking-widest uppercase">
                SS GLOBAL TRADE
              </h3>
              <p className="text-cream-muted text-xs tracking-widest uppercase mt-1 font-semibold">
                Premium Human Hair Exporter
              </p>
            </div>
            <p className="text-cream-muted text-sm leading-relaxed mb-6 font-medium">
              Premium human hair supplier serving global brands, salons, and
              wholesalers with quality you can trust.
            </p>
            <div className="flex items-center gap-3">
              <div className="h-px w-8 bg-gold/40" />
              <span className="text-gold/60 text-xs tracking-widest uppercase font-bold">
                Est. India
              </span>
            </div>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-heading font-bold text-cream text-base mb-5 pb-2 border-b border-gold/20 uppercase tracking-wide">
              Quick Links
            </h4>
      ...
      <div className="border-t border-gold/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-cream-muted text-xs tracking-wide font-medium">
            © {currentYear} SS GLOBAL TRADE. All rights reserved.
          </p>
