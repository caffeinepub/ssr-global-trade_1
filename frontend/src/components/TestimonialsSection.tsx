...
const testimonials = [
  {
    quote:
      'SS GLOBAL TRADES has been our trusted supplier for over 2 years. The quality is consistently excellent, and their customer service is outstanding. Highly recommended!',
    name: 'Sarah Johnson',
  ...
  {
    quote:
      'Fast shipping, transparent communication, and premium quality products. SS GLOBAL TRADES is our go-to supplier for all human hair needs.',
    name: 'Emma Williams',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="text-gold text-xs font-black tracking-[0.3em] uppercase">Testimonials</span>
            <div className="h-px w-10 bg-gold" />
          </div>
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-cream-muted text-xs font-medium">{t.location}</p>
                </div>
              </div>
            </div>
          ))}
