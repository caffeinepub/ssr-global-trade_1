...
export type Product = { 'oemPrivateLabel' : null } |
  { 'hairBundles' : null } |
  { 'bulkSupply' : null } |
  { 'customWigs' : null } |
...
export interface _SERVICE {
  ...
  'getBusinessHours' : ActorMethod<
    [],
    { 'saturday' : string, 'sunday' : string, 'mondayToFriday' : string }
  >,
  ...
  'submitQuoteRequest' : ActorMethod<
    [string, string, string, string, Product, string],
    undefined
  >,
}
